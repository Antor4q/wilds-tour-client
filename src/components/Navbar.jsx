    ...
    return (
        <div className="lg:max-w-[1240px]   mx-auto  text-white bg-[#5356FF]">
            ...
            <div className="navbar-start">
                ...
                <ul tabIndex={0} className="menu menu-sm text-black dropdown-content mt-3 z-10 p-2 shadow bg-base-100 rounded-box w-52">
                    {
                        nav
                    }
                </ul>
            ...
            <div className="navbar-end gap-2">
                ...
                <Link to="/login" className="border-x lg:px-5 px-3 text-white">Login</Link>
